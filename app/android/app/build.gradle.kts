...
android {
    ...
    defaultConfig {
        applicationId = "com.boundfoxstudios.apps.flugwacht"
    ...
    buildTypes {
        release {
            // Falls back to debug signing when no key.properties is present, so
            // local `flutter run --release` and secretless CI builds keep working
            signingConfig =
                if (keystorePropertiesFile.exists()) {
